...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-surface px-6 py-32 dark:bg-slate-950">
      <div className="mx-auto max-w-3xl rounded-3xl border border-red-200 bg-white p-10 shadow-sm dark:border-red-900/40 dark:bg-slate-900">
        <h1 className="text-3xl font-black text-primary dark:text-emerald-50">Could not load this equipment page.</h1>
