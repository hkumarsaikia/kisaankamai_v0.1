...
{/*  Map Placeholder  */}
<div className="absolute inset-0 bg-cover bg-center" data-alt="stylized map view of rural Maharashtra showing farmland divisions and road network" data-location="Nashik, Maharashtra" style={{'backgroundImage': 'url(\'https'}}></div>
