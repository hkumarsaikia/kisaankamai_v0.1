...
export default function EquipmentDetail({ params }: { params: { slug: string } }) {
  return (
    <div className="min-h-screen flex flex-col bg-background dark:bg-slate-950">
      <main className="flex-grow pt-24 pb-12 px-4 md:px-8 max-w-screen-2xl mx-auto">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <section className="space-y-4">
              <div className="aspect-[16/9] w-full rounded-3xl overflow-hidden bg-surface-variant relative group">
                <ContentImage className="w-full h-full object-cover" alt="Modern high-performance John Deere tractor parked in a lush green Indian sugarcane field at sunrise with warm cinematic lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDSyY2H9kmQ5H_MJHOrceuJUebS7Ji01L0-gQwyB68e-c7XWXXfhkzYDyyWBZYBrMRAg1sexAjcmLl4rsCV8RP3knzPrAAOJ73B9al5H57K4KHMjynhj35aIj2UbXmoF1iZdm0AVkLKJNcSWXWFEtcL1e8sCEW0jgL6XVBESQHx7djz0eaOUHCale4bGXMqTqDgctAQZVD75FZtMTGXQbFmD4gJwPlglP6t4xN6YA4q4_wm1VPpSmoCvsG9LNyEty-MjtgEq-pSdkbf" loading="lazy" decoding="async" />
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="aspect-square rounded-2xl overflow-hidden bg-surface-variant">
                  <ContentImage className="w-full h-full object-cover" alt="Close up view of tractor engine and heavy duty wheels in an agricultural setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAh9eiUT5qY0JurzZdIslVNqF7pZNYO1y6LAaS8RSxom-FogcaqyPRMDnW_493lmSmyl7iic7hWm1CCC2dsfXxLHqbo2XV25KP6hqSErCCSmp5ctrTUQE8MuIyejzg5rUsE9xVMm5GDcmQdpF5_Se_lsQn4zgd6loLqGeITe2o3tfmFetq9rME5454MmIiUYDmUtYhXbepoHmYtnSPjP-mxKWnWgNvik-F8yu5BMIAeJMjtYGC_y-P4CKI87wSqu-3c2rL6JLp00VQ4" loading="lazy" decoding="async" />
                </div>
                <div className="aspect-square rounded-2xl overflow-hidden bg-surface-variant">
                  <ContentImage className="w-full h-full object-cover" alt="Ergonomic dashboard and controls inside a modern tractor cabin" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDJUayHc4m8eHQkQSlfUK-R5jvF0g5GtZfHm6Ya9vR5eq0ndLOT8pUFBV9oN8VAY2VQukqBtZVxPl70x0bq2WEj-xKWzEn6WV8D2oUu2wcP7YgdFgNRFRpM96aMZeKWonakgA2jVZHG2etfijeH4KGAwIzYzPCNL0WdHBy7hVwB7DOeSmyQ5hn5gWV_-G9YroXHNEkKCelFqHq59OIVR_3A46U4hRAast-iHSAVTlNu6C2ANbset1-ZfRNc66dpHOA7WDrs2dQvt_g6" loading="lazy" decoding="async" />
                </div>
                <div className="aspect-square rounded-2xl overflow-hidden bg-surface-variant">
                  <ContentImage className="w-full h-full object-crop" alt="Rear view of tractor with rotavator attachment in a plowed field" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCXl4OftQjfNzN_r4M-_69LZ8nlx8tLuvc0JnRfU_q-I2u-jVTez_jgxihOCs4fcinOX5VuMj_GEBDFkirhWvRentCkYNUBzTvO1d2lVN8K3mBO7EPst1O6YcrB-CfUFt5MJd4gReaoZMezfvqLijoUaiDd61dR69AI-qXWqUI30B2pIzk2wUH3D5pcztdT7VBRyMRjDew0EUemZWAPXIAKA6R0pC5pTVoa8JKdpt9z1E0t1QJcIMII6gGsNYRqAf8_2ziCBOXl55Yx" loading="lazy" decoding="async" />
                </div>
          ...
          <div className="flex gap-6 overflow-x-auto no-scrollbar pb-8">
            ...
            <div className="min-w-[320px] bg-white rounded-3xl border border-outline-variant/30 overflow-hidden group">
              <div className="h-48 overflow-hidden relative">
                <ContentImage className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Powerful Mahindra tractor in a golden sunset field" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD8aPstg-9kV4PXknfBO-qOSkcyG7JAfRa3VhAam-Tpe4-Nf1DddIgB64mI66T79HrpdTgJwexYkRVqGCvP1A4z0nySQvwXfRxwpB5gaWL6EnppfR9l37aIPGHHdZR7YSOaSC0biV2jDSDZPuM8LiHOjPgruIl0V_IdifjgzkwW0lihQuDy2lKqmxNEh-a-_FRJHHoy18rZxgHo3rTE8MvZl0uFof2VdUVsEAq9PMhmC9ZBRuNQ3xL5ZBBDxaRk2LmzVig274QdYdbP" loading="lazy" decoding="async" />
            ...
            <div className="min-w-[320px] bg-white rounded-3xl border border-outline-variant/30 overflow-hidden group">
              <div className="h-48 overflow-hidden relative">
                <ContentImage className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Powerful Swaraj tractor with cultivator attached" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCZ8KKP9IQY6iTtx_mDUut7Zwgt7dulqWr4f78pfv_Mz3YyOpjsfX_VphS6KACpflaIrGIRarva1w5pPlKs_4VUgU2qVCFcTvg9SYSr9F3FIpI0js07bOjcZd-v-H3yn077dTU2kT9qyvpkkfmUyCeEYeEG_WEMcT8oLTZas2fYmpMdyH-UomWZ-hB6d1R7KTi-NO_-6p76avaQrsizhcKjwzFYiz87Lw0u4Fo6aEDZD2VEb2gsQ_7O5JBWt73xgQYAqynwQPkIinfp" loading="lazy" decoding="async" />
        ...
        {/*  Bottom Nav for Mobile Only (Managed by Layout)  */}
      </main>
    </div>
  );
}
