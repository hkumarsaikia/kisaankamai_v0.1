        ...
        <section className="max-w-7xl mx-auto px-6 -mt-20 relative z-20 mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="kk-depth-tile bg-surface-container-lowest p-8 rounded-3xl shadow-2xl shadow-primary/5 border border-outline-variant hover:border-primary/30 transition-all group">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  <div key={i} className="kk-depth-tile bg-white/10 p-8 rounded-3xl border border-white/5 flex gap-6 items-start hover:bg-white/15 transition-colors">
        ...
        <section className="max-w-7xl mx-auto px-6 py-24 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="kk-depth-tile p-10 border border-error/25 bg-error-container/10 rounded-[2.5rem] text-center hover:scale-[1.02] transition-transform">
