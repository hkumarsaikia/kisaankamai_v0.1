...
export default function RenterProfileError({
  error,
  reset,
}: {
  ...
  return (
    <div className="rounded-3xl border border-red-200 bg-red-50 p-8 text-red-800">
      <h2 className="text-2xl font-black">Renter Profile Error</h2>
      <p className="mt-3 text-sm font-medium">
        {error.message || "We could not load this renter workspace section."}
      </p>
      <button
        onClick={() => reset()}
