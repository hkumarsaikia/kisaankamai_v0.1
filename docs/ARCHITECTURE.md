...
- `/catalog/[slug]` is a compatibility redirect to `/rent-equipment?query=<slug>`. The public category experience stays on live marketplace search pages unless a future SEO landing-page rollout is explicitly approved and reviewed.
