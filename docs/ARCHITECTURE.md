...
- `/catalog/[slug]` is the approved programmatic SEO surface. It uses source-controlled baseline category data, live listing counts, canonical metadata, sitemap entries, and structured data without creating speculative category-location doorway pages.
